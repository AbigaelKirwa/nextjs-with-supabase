...
export default function ReadToDo({toDoItems, tableHeaderNames, name, priority, setName, setPriority, setUpdateTask, handleUpdate, setDone, handleDelete, handleCheckboxUpdate}:ReactToDoProps) {
  return (
